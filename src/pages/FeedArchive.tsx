...
const FeedArchive = () => {
    ...
    return (
        <div className="min-h-screen bg-cream text-gray-900 selection:bg-black selection:text-white">
            ...
            <main className="pt-32 pb-24 px-2 lg:px-12">
...
const ArticleCard = ({ post, isExternal = false }: { post: ArticlePost, isExternal?: boolean }) => (
    <article className="flex flex-col md:flex-row gap-8 items-center bg-white p-3 md:p-6 rounded-[2rem] border-2 border-black shadow-sm group-hover:shadow-xl transition-all duration-300">
