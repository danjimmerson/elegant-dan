            ...
            <div className="container mx-auto px-6 lg:px-12">
                ...
                <div className="grid lg:grid-cols-12 gap-8 lg:gap-12">
                    ...
                    <div className="lg:col-span-7">
                        {featuredPost.type === 'curated' ? (
                            <a href={featuredPost.link} target="_blank" rel="noopener noreferrer" className="group block h-full">
                                <div className="h-full flex flex-col rounded-3xl overflow-hidden bg-white shadow-sm border-2 border-black group-hover:shadow-xl transition-all duration-500">
                                    ...
                                    <div className="p-6 lg:p-10 flex flex-col gap-4 flex-1">
                                        ...
                                        <div className="mt-auto pt-6 flex items-center gap-2 text-sm font-bold text-black uppercase tracking-wide group-hover:gap-4 transition-all">
                                            Visit Link <ArrowUpRight className="w-4 h-4" />
                                        </div>
                                    </div>
                                </div>
                            </a>
